<div class="p-6">
    <form wire:submit.prevent="save" class="flex flex-col w-[400px] mx-auto py-16">
        @if($image)
            ...
            <div class="flex flex-wrap justify-center gap-6">
                @foreach($image as $img)
                    <img src="{{$img->temporaryUrl()}}" alt="an image" class="w-[110px] h-[90px] object-cover">
                @endforeach()
            </div>
        @endif
        ...
        @enderror
        <button type="submit" class="py-2 px-4 bg-indigo-500 hover:bg-indigo-600 rounded text-white">Save</button>
    </form>
